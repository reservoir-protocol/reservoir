...
import {ICurveStableSwap, EthenaSUSDEAdapter} from "src/adapters/EthenaUSDEAdapter.sol";
...
contract EthenaUSDEAdapterTest is Test {
    ...
    EthenaSUSDEAdapter public adapter;
    ...
    function setUp() external {
        ...
        adapter = new EthenaSUSDEAdapter(
            address(this),
            0x790700f73b59b5cD87680654211266eA0A52D087,
    ...
    function testFundTotalValue() external {
        console.log(" - - - - - - - - - - - - - - - - -- - - - - - - - - - - ");
